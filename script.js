    ...
    try{
      ...
      var resposta = await fetch(apiBase + "/criar-pagamento", {
        ...
        body: JSON.stringify({
          ...
          desconto: Number(window.descontoCupomMS || descontoCupomMS || 0),
          codigoCupom: String(window.codigoCupomAplicadoMS || codigoCupomAplicadoMS || "").trim(),
      ...
      // Checkout completo do Mercado Pago na mesma aba.
      // Exibe Pix, cartão e os demais meios habilitados na conta.
      if(typeof esconderLoadingCheckout === "function") esconderLoadingCheckout();
...
/* Controlador PIX exclusivo removido. */
