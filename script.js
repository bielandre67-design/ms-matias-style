...
(function(){
  ...
  async function finalizarCompraMPCorrigido(event){
    ...
    try{
      ...
      // Usa a mesma aba. O Checkout Pro exibirá Pix, cartão e os demais
      // meios liberados na conta. Depois do pagamento, o Mercado Pago retorna
      // para a página de confirmação configurada no servidor.
      localStorage.setItem("msPedidoAguardandoConfirmacao", String(pedidoIdMS));
      if(typeof esconderLoadingCheckout === "function") esconderLoadingCheckout();
