...
(function(){
  ...
  let categoriasMS = [];
  let filtroProdutosGerenciadorMS = 'todos';
  ...
  function criarInterface(){
    ...
    sec.innerHTML=`
      <style>
      #abaProdutosMS{padding:24px;color:#f4f4f4}.ms-prod-head{display:flex;justify-content:space-between;gap:14px;align-items:center;flex-wrap:wrap;margin-bottom:20px}.ms-prod-head h2{margin:0;font-size:28px}.ms-prod-toolbar{display:grid;grid-template-columns:minmax(220px,1fr) auto;gap:12px;margin-bottom:16px;padding:14px;border:1px solid rgba(255,255,255,.1);border-radius:18px;background:#14171d}.ms-prod-search{display:flex;align-items:center;gap:9px;min-height:46px;padding:0 13px;border:1px solid rgba(255,255,255,.14);border-radius:13px;background:#0f1116}.ms-prod-search input{width:100%;border:0!important;background:transparent!important;padding:0!important;color:#fff;outline:0}.ms-prod-filtros{display:flex;gap:8px;flex-wrap:wrap}.ms-prod-filtro{min-height:46px;padding:0 13px;border:1px solid rgba(255,255,255,.13);border-radius:13px;background:#20242d;color:#fff;font-weight:850;cursor:pointer}.ms-prod-filtro.ativo{background:#d8ad43;color:#111;border-color:#d8ad43}.ms-prod-form-title{grid-column:1/-1;display:flex;justify-content:space-between;align-items:center;gap:12px;padding-bottom:12px;border-bottom:1px solid rgba(255,255,255,.1)}.ms-prod-form-title h3{margin:0;font-size:20px}.ms-prod-form-title span{font-size:11px;font-weight:950;color:#d8ad43}.ms-prod-btn{border:0;border-radius:14px;padding:12px 18px;font-weight:900;cursor:pointer;background:#d8ad43;color:#111}.ms-prod-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:14px}.ms-prod-card{background:#14171d;border:1px solid rgba(255,255,255,.1);border-radius:20px;padding:16px;display:grid;grid-template-columns:76px 1fr;gap:14px;transition:.18s ease}.ms-prod-card:hover{transform:translateY(-2px);border-color:rgba(216,173,67,.35)}.ms-prod-card img{width:76px;height:96px;object-fit:cover;border-radius:12px;background:#222}.ms-prod-card h3{margin:0 0 7px}.ms-prod-meta{font-size:13px;color:#aaa}.ms-prod-acoes{grid-column:1/-1;display:flex;gap:8px}.ms-prod-acoes button{flex:1;border:1px solid rgba(255,255,255,.13);background:#20242d;color:white;border-radius:12px;padding:10px;cursor:pointer;font-weight:800}.ms-prod-acoes .duplicar{color:#d8ad43}.ms-prod-acoes .excluir{color:#ff8a98}.ms-prod-form{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px;background:#14171d;border:1px solid rgba(255,255,255,.1);padding:18px;border-radius:20px;margin-bottom:18px}.ms-prod-form label{display:grid;gap:6px;font-size:13px;font-weight:800}.ms-prod-form input,.ms-prod-form textarea,.ms-prod-form select{background:#0f1116;color:white;border:1px solid rgba(255,255,255,.14);border-radius:12px;padding:11px}.ms-prod-form textarea{min-height:85px;resize:vertical}.ms-prod-full{grid-column:1/-1}.ms-upload-box{grid-column:1/-1;border:1px dashed rgba(216,173,67,.6);border-radius:18px;padding:16px;background:rgba(216,173,67,.05)}.ms-upload-top{display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap}.ms-upload-btn{display:inline-flex;align-items:center;gap:8px;background:#d8ad43;color:#111;padding:11px 15px;border-radius:12px;font-weight:950;cursor:pointer}.ms-upload-btn input{display:none}.ms-upload-help{font-size:12px;color:#aaa;margin-top:6px}.ms-preview-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(112px,1fr));gap:10px;margin-top:14px}.ms-preview{position:relative;border:1px solid rgba(255,255,255,.12);border-radius:14px;overflow:hidden;background:#0f1116}.ms-preview img{width:100%;height:130px;object-fit:cover;display:block}.ms-preview-main{position:absolute;left:7px;top:7px;background:#d8ad43;color:#111;font-size:10px;font-weight:950;padding:5px 7px;border-radius:999px}.ms-preview-actions{display:grid;grid-template-columns:1fr 38px;gap:6px;padding:7px}.ms-preview-actions button{border:0;border-radius:9px;padding:8px;background:#252a34;color:#fff;cursor:pointer;font-size:11px}.ms-preview-actions .danger{background:#4a1820}.ms-medidas-box{grid-column:1/-1;padding:14px;border:1px solid rgba(216,173,67,.28);border-radius:16px;background:rgba(216,173,67,.055)}.ms-medidas-title{font-weight:950;margin-bottom:4px}.ms-medidas-ajuda{font-size:12px;color:#aaa;margin-bottom:12px}.ms-medidas-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px}.ms-medidas-status{margin-top:7px;font-size:12px;font-weight:850}.ms-medidas-ok{color:#66db7b}.ms-medidas-pendente{color:#ffd36a}.ms-checks{display:flex;gap:16px;align-items:center;flex-wrap:wrap}.ms-checks label{display:flex;grid-auto-flow:column;align-items:center}.ms-form-actions{display:flex;gap:10px;position:sticky;bottom:10px;z-index:5;padding:10px;border:1px solid rgba(255,255,255,.1);border-radius:15px;background:rgba(20,23,29,.96);backdrop-filter:blur(10px)}.ms-form-actions button{min-height:46px}.ms-prod-preview-live{grid-column:1/-1;display:grid;grid-template-columns:80px 1fr auto;gap:12px;align-items:center;padding:12px;border:1px solid rgba(216,173,67,.26);border-radius:16px;background:rgba(216,173,67,.055)}.ms-prod-preview-live img{width:80px;height:92px;object-fit:cover;border-radius:12px;background:#222}.ms-prod-preview-live strong{display:block;margin-bottom:5px}.ms-prod-preview-live small{color:#aaa}.ms-prod-preview-price{font-weight:950;color:#d8ad43;white-space:nowrap}.ms-msg{padding:11px 13px;border-radius:12px;background:#20242d;margin-bottom:14px;display:none}.ms-saving{opacity:.65;pointer-events:none}@media(max-width:700px){.ms-prod-toolbar{grid-template-columns:1fr}.ms-prod-filtros{display:grid;grid-template-columns:repeat(3,1fr)}.ms-prod-filtro{padding:0 8px}.ms-prod-form{grid-template-columns:1fr}.ms-prod-full,.ms-medidas-box,.ms-upload-box{grid-column:auto}.ms-medidas-grid{grid-template-columns:1fr 1fr}}@media(max-width:430px){.ms-prod-preview-live{grid-template-columns:64px 1fr}.ms-prod-preview-live img{width:64px;height:76px}.ms-prod-preview-price{grid-column:2}.ms-form-actions{display:grid;grid-template-columns:1fr 1fr}.ms-form-actions #salvarProdutoBtnMS{grid-column:1/-1}.ms-medidas-grid{grid-template-columns:1fr}.ms-preview-grid{grid-template-columns:1fr 1fr}}
      </style>
      ...
      <div class="ms-prod-toolbar"><label class="ms-prod-search"><span>⌕</span><input id="buscaGerenciadorProdutosMS" placeholder="Buscar nome ou categoria" oninput="renderProdutosGerenciadorMS()"></label><div class="ms-prod-filtros"><button class="ms-prod-filtro ativo" data-filtro-produto="todos" onclick="filtrarProdutosGerenciadorMS('todos',this)">Todos</button><button class="ms-prod-filtro" data-filtro-produto="ativos" onclick="filtrarProdutosGerenciadorMS('ativos',this)">Ativos</button><button class="ms-prod-filtro" data-filtro-produto="ocultos" onclick="filtrarProdutosGerenciadorMS('ocultos',this)">Ocultos</button></div></div>
      <div id="msgProdutoMS" class="ms-msg"></div>
      <form id="formProdutoMS" class="ms-prod-form" style="display:none">
        <div class="ms-prod-form-title"><div><h3 id="tituloFormProdutoMS">Novo produto</h3><small class="ms-prod-meta">Preencha os dados e salve no final</small></div><span id="modoFormProdutoMS">NOVO</span></div>
...
M: busto 55 cm | comprimento 70 cm"></textarea></label><label>Detalhes do produto<textarea id="produtoDetalhesMS" placeholder="Modelagem, acabamento, bolsos, capuz e outros detalhes."></textarea></label><label>Composição<textarea id="produtoComposicaoMS" placeholder="Ex.: 50% algodão e 50% poliéster."></textarea></label><label>Cuidados com a peça<textarea id="produtoCuidadosMS" placeholder="Ex.: lavar do avesso, não usar alvejante e secar à sombra."></textarea></label></div></div>
        ...
        <div class="ms-prod-preview-live"><img id="previewProdutoImagemMS" src="logo.png" onerror="this.src='logo.png'"><div><strong id="previewProdutoNomeMS">Nome do produto</strong><small id="previewProdutoMetaMS">Categoria · Ativo</small></div><div id="previewProdutoPrecoMS" class="ms-prod-preview-price">R$ 0,00</div></div>
        ...
        <div class="ms-form-actions ms-prod-full"><button id="salvarProdutoBtnMS" class="ms-prod-btn" type="submit">Salvar produto</button><button type="button" onclick="cancelarProdutoMS()">Cancelar</button><button type="button" onclick="alternarGerenciadorCategoriasMS()">Categorias</button></div>
  ...
  window.novoProdutoMS=async function(){ document.getElementById('formProdutoMS').reset(); produtoIdMS.value=''; if(!categoriasMS.length) await carregarCategoriasMS(); produtoCategoriaMS.value=categoriasMS[0]?.nome||'Roupas'; imagensSelecionadasMS=[]; renderPreviewMS(); atualizarStatusMedidasMS(); produtoAtivoMS.checked=true; document.getElementById('tituloFormProdutoMS').textContent='Novo produto'; document.getElementById('modoFormProdutoMS').textContent='NOVO'; formProdutoMS.style.display='grid'; atualizarPreviewProdutoAoVivoMS(); formProdutoMS.scrollIntoView({behavior:'smooth',block:'start'}); setTimeout(()=>produtoNomeMS.focus(),350); };
  ...
  function selecionarImagensMS(e){
    ...
    e.target.value=''; renderPreviewMS(); atualizarPreviewProdutoAoVivoMS();
  }
  ...
  window.principalImagemMS=function(i){const [x]=imagensSelecionadasMS.splice(i,1);imagensSelecionadasMS.unshift(x);renderPreviewMS();atualizarPreviewProdutoAoVivoMS();};
  window.removerImagemMS=function(i){const [x]=imagensSelecionadasMS.splice(i,1);if(x?.tipo==='arquivo')URL.revokeObjectURL(x.url);renderPreviewMS();atualizarPreviewProdutoAoVivoMS();};
  ...
  function render(){const box=listaProdutosMS;const busca=String(document.getElementById('buscaGerenciadorProdutosMS')?.value||'').trim().toLowerCase();const lista=produtos.filter(p=>(!busca||`${p.nome||''} ${p.categoria||''}`.toLowerCase().includes(busca))&&(filtroProdutosGerenciadorMS==='todos'||(filtroProdutosGerenciadorMS==='ativos'&&p.ativo)||(filtroProdutosGerenciadorMS==='ocultos'&&!p.ativo)));if(!lista.length){box.innerHTML='<p class="ms-prod-meta">Nenhum produto encontrado.</p>';return;}box.innerHTML=lista.map(p=>`<article class="ms-prod-card"><img src="${esc(p.imagem||'logo.png')}" onerror="this.src='logo.png'"><div><h3>${esc(p.nome)}</h3><div class="ms-prod-meta">${esc(p.categoria)} · ${moeda(p.preco)}</div><div class="ms-prod-meta">${p.ativo?'Ativo':'Oculto'}${p.destaque?' · Destaque':''}${p.promocao?' · Promoção':''}</div><div class="ms-medidas-status ${p.medidasCompletas?'ms-medidas-ok':'ms-medidas-pendente'}">${p.medidasCompletas?`⚖️ ${num(p.pesoKg).toFixed(3)} kg · ${num(p.comprimentoCm)}×${num(p.larguraCm)}×${num(p.alturaCm)} cm`:'⚠️ Medidas de frete pendentes'}</div></div><div class="ms-prod-acoes"><button onclick="editarProdutoMS(${p.id})">✏️ Editar</button><button class="duplicar" onclick="duplicarProdutoMS(${p.id})">⧉ Duplicar</button><button class="excluir" onclick="excluirProdutoMS(${p.id})">Excluir</button></div></article>`).join('');}
  window.renderProdutosGerenciadorMS=render;
  window.filtrarProdutosGerenciadorMS=function(filtro,btn){filtroProdutosGerenciadorMS=filtro;document.querySelectorAll('[data-filtro-produto]').forEach(b=>b.classList.toggle('ativo',b===btn));render();};
  window.editarProdutoMS=async function(id){const p=produtos.find(x=>x.id===id);if(!p)return;await novoProdutoMS();produtoIdMS.value=p.id;produtoNomeMS.value=p.nome||'';produtoCategoriaMS.value=p.categoria||categoriasMS[0]?.nome||'Roupas';produtoPrecoMS.value=p.preco||0;produtoPrecoAntigoMS.value=p.precoAntigo??'';imagensSelecionadasMS=[p.imagem,...(p.imagens||[])].filter((v,i,a)=>v&&a.indexOf(v)===i).map(url=>({tipo:'url',url}));renderPreviewMS();produtoDescricaoMS.value=p.descricao||'';produtoTabelaMedidasMS.value=p.tabelaMedidas||'';produtoDetalhesMS.value=p.detalhesProduto||'';produtoComposicaoMS.value=p.composicao||'';produtoCuidadosMS.value=p.cuidados||'';produtoCoresMS.value=(p.cores||[]).join(', ');produtoTamanhosMS.value=(p.tamanhos||['P','M','G','GG']).join(', ');produtoPesoKgMS.value=p.pesoKg||'';produtoAlturaCmMS.value=p.alturaCm||'';produtoLarguraCmMS.value=p.larguraCm||'';produtoComprimentoCmMS.value=p.comprimentoCm||'';atualizarStatusMedidasMS();produtoQuantidadeMS.value=0;produtoAtivoMS.checked=!!p.ativo;produtoDestaqueMS.checked=!!p.destaque;produtoPromocaoMS.checked=!!p.promocao;document.getElementById('tituloFormProdutoMS').textContent=`Editar ${p.nome}`;document.getElementById('modoFormProdutoMS').textContent='EDITANDO';atualizarPreviewProdutoAoVivoMS();};
  window.duplicarProdutoMS=async function(id){const p=produtos.find(x=>x.id===id);if(!p)return;await editarProdutoMS(id);produtoIdMS.value='';produtoNomeMS.value=`${p.nome} - Cópia`;produtoQuantidadeMS.value=0;document.getElementById('tituloFormProdutoMS').textContent='Duplicar produto';document.getElementById('modoFormProdutoMS').textContent='CÓPIA';atualizarPreviewProdutoAoVivoMS();produtoNomeMS.focus();};
  function atualizarPreviewProdutoAoVivoMS(){const nome=document.getElementById('produtoNomeMS')?.value.trim()||'Nome do produto';const categoria=document.getElementById('produtoCategoriaMS')?.value||'Sem categoria';const preco=num(document.getElementById('produtoPrecoMS')?.value);const ativo=document.getElementById('produtoAtivoMS')?.checked;const img=imagensSelecionadasMS[0]?.url||'logo.png';const elImg=document.getElementById('previewProdutoImagemMS');if(elImg)elImg.src=img;const elNome=document.getElementById('previewProdutoNomeMS');if(elNome)elNome.textContent=nome;const elMeta=document.getElementById('previewProdutoMetaMS');if(elMeta)elMeta.textContent=`${categoria} · ${ativo?'Ativo':'Oculto'}`;const elPreco=document.getElementById('previewProdutoPrecoMS');if(elPreco)elPreco.textContent=moeda(preco);}
  document.addEventListener('input',e=>{if(['produtoNomeMS','produtoPrecoMS','produtoCategoriaMS','produtoAtivoMS'].includes(e.target?.id))atualizarPreviewProdutoAoVivoMS();});
  document.addEventListener('change',e=>{if(['produtoCategoriaMS','produtoAtivoMS'].includes(e.target?.id))atualizarPreviewProdutoAoVivoMS();});
...
const FRETE_PADRAO_ADMIN_MS={entregaAtiva:true,retiradaAtiva:true,cepOrigem:'90640130',diasPreparacao:1,gratisAtivo:false,gratisAcima:199.90,fixoAtivo:false,fixoValor:15,pesoPadrao:.5,alturaPadrao:6,larguraPadrao:28,comprimentoPadrao:35,medidasCategorias:{},regioes:{sul:{ativo:true,min:3,max:7},sudeste:{ativo:true,min:4,max:8},centroOeste:{ativo:true,min:5,max:10},nordeste:{ativo:true,min:7,max:14},norte:{ativo:true,min:9,max:18}}};
let configFreteAdminMS=JSON.parse(JSON.stringify(FRETE_PADRAO_ADMIN_MS));
function chaveCategoriaFreteAdminMS(valor){return String(valor||'sem-categoria').normalize('NFD').replace(/[\u0300-\u036f]/g,'').trim().toLowerCase().replace(/[^a-z0-9]+/g,'-').replace(/^-+|-+$/g,'')||'sem-categoria';}
let categoriasFreteAdminMS=[];
async function carregarCategoriasMedidasFreteMS(forcar=false){
  const box=document.getElementById('freteMedidasCategoriasMS');if(!box)return;
  if(forcar)box.innerHTML='<p>Atualizando categorias...</p>';
  try{
    const r=await fetch(`${API_ADMIN_MS}/produtos?t=${Date.now()}`,{cache:'no-store'});
    const d=await r.json();if(!r.ok)throw new Error('Falha ao carregar produtos');
    const produtos=Array.isArray(d)?d:(d.produtos||[]);
    const mapa=new Map();produtos.forEach(p=>{const nome=String(p.categoria||'Sem categoria').trim();mapa.set(chaveCategoriaFreteAdminMS(nome),nome);});
    Object.entries(configFreteAdminMS.medidasCategorias||{}).forEach(([k,v])=>mapa.set(k,v.nome||k));
    categoriasFreteAdminMS=[...mapa.entries()].sort((x,y)=>x[1].localeCompare(y[1],'pt-BR'));
    renderMedidasCategoriasFreteMS();
  }catch(e){
    categoriasFreteAdminMS=Object.entries(configFreteAdminMS.medidasCategorias||{}).map(([k,v])=>[k,v.nome||k]);
    renderMedidasCategoriasFreteMS();
    if(!categoriasFreteAdminMS.length)box.innerHTML='<p>Não consegui carregar as categorias.</p>';
  }
}
function renderMedidasCategoriasFreteMS(){
  const box=document.getElementById('freteMedidasCategoriasMS');if(!box)return;
  if(!categoriasFreteAdminMS.length){box.innerHTML='<p>Cadastre ao menos um produto para aparecer uma categoria aqui.</p>';return;}
  box.innerHTML=categoriasFreteAdminMS.map(([k,nome])=>{const m=configFreteAdminMS.medidasCategorias?.[k]||{};return `<article class="frete-medida-categoria-ms" data-medida-categoria="${k}" data-medida-nome="${String(nome).replace(/"/g,'&quot;')}"><h4>${nome}</h4><div class="frete-medida-grid-ms"><label>Peso <small>quilogramas</small><input type="number" min="0.001" step="0.001" value="${Number(m.peso||0)||''}" data-medida-campo="peso" placeholder="0,450"></label><label>Altura <small>centímetros</small><input type="number" min="1" step="0.1" value="${Number(m.altura||0)||''}" data-medida-campo="altura" placeholder="6"></label><label>Largura <small>centímetros</small><input type="number" min="1" step="0.1" value="${Number(m.largura||0)||''}" data-medida-campo="largura" placeholder="28"></label><label>Comprimento <small>centímetros</small><input type="number" min="1" step="0.1" value="${Number(m.comprimento||0)||''}" data-medida-campo="comprimento" placeholder="35"></label></div></article>`}).join('');
}
function lerMedidasCategoriasFreteMS(){const medidas={};document.querySelectorAll('[data-medida-categoria]').forEach(card=>{const k=card.dataset.medidaCategoria,nome=card.dataset.medidaNome;const get=c=>Math.max(0,Number(card.querySelector(`[data-medida-campo="${c}"]`)?.value||0));medidas[k]={nome,peso:get('peso'),altura:get('altura'),largura:get('largura'),comprimento:get('comprimento')};});return medidas;}
...
function lerConfigFreteFormMS(){const regioes={};REGIOES_FRETE_MS.forEach(([k])=>{const min=Math.max(1,Number(document.querySelector(`[data-frete-min="${k}"]`)?.value||1));const max=Math.max(min,Number(document.querySelector(`[data-frete-max="${k}"]`)?.value||min));regioes[k]={ativo:document.querySelector(`[data-frete-regiao="${k}"]`)?.checked!==false,min,max};});return {entregaAtiva:!!document.getElementById('freteEntregaAtivaMS')?.checked,retiradaAtiva:!!document.getElementById('freteRetiradaAtivaMS')?.checked,cepOrigem:String(document.getElementById('freteCepOrigemMS')?.value||'').replace(/\D/g,''),diasPreparacao:Math.max(0,Number(document.getElementById('freteDiasPreparacaoMS')?.value||0)),gratisAtivo:!!document.getElementById('freteGratisAtivoMS')?.checked,gratisAcima:Math.max(0,Number(document.getElementById('freteGratisValorMS')?.value||0)),fixoAtivo:!!document.getElementById('freteFixoAtivoMS')?.checked,fixoValor:Math.max(0,Number(document.getElementById('freteFixoValorMS')?.value||0)),pesoPadrao:Math.max(.001,Number(document.getElementById('fretePesoPadraoMS')?.value||.5)),alturaPadrao:Math.max(1,Number(document.getElementById('freteAlturaPadraoMS')?.value||6)),larguraPadrao:Math.max(1,Number(document.getElementById('freteLarguraPadraoMS')?.value||28)),comprimentoPadrao:Math.max(1,Number(document.getElementById('freteComprimentoPadraoMS')?.value||35)),medidasCategorias:lerMedidasCategoriasFreteMS(),regioes};}
function preencherConfigFreteMS(c){configFreteAdminMS={...FRETE_PADRAO_ADMIN_MS,...c,medidasCategorias:{...(c?.medidasCategorias||{})},regioes:{...FRETE_PADRAO_ADMIN_MS.regioes,...(c?.regioes||{})}};document.getElementById('freteEntregaAtivaMS').checked=configFreteAdminMS.entregaAtiva!==false;document.getElementById('freteRetiradaAtivaMS').checked=configFreteAdminMS.retiradaAtiva!==false;document.getElementById('freteCepOrigemMS').value=String(configFreteAdminMS.cepOrigem||'');document.getElementById('freteDiasPreparacaoMS').value=Number(configFreteAdminMS.diasPreparacao||0);document.getElementById('freteGratisAtivoMS').checked=!!configFreteAdminMS.gratisAtivo;document.getElementById('freteGratisValorMS').value=Number(configFreteAdminMS.gratisAcima||0).toFixed(2);document.getElementById('freteFixoAtivoMS').checked=!!configFreteAdminMS.fixoAtivo;document.getElementById('freteFixoValorMS').value=Number(configFreteAdminMS.fixoValor||0).toFixed(2);document.getElementById('fretePesoPadraoMS').value=Number(configFreteAdminMS.pesoPadrao||.5);document.getElementById('freteAlturaPadraoMS').value=Number(configFreteAdminMS.alturaPadrao||6);document.getElementById('freteLarguraPadraoMS').value=Number(configFreteAdminMS.larguraPadrao||28);document.getElementById('freteComprimentoPadraoMS').value=Number(configFreteAdminMS.comprimentoPadrao||35);renderRegioesFreteMS();carregarCategoriasMedidasFreteMS();}
function atualizarResumoFreteAdminMS(){if(!document.getElementById('freteResumoRegraMS'))return;const c=lerConfigFreteFormMS();const ativas=REGIOES_FRETE_MS.filter(([k])=>c.regioes[k].ativo).map(([,n])=>n);let partes=[];partes.push(c.entregaAtiva?(c.fixoAtivo?`Frete fixo de ${Number(c.fixoValor).toLocaleString('pt-BR',{style:'currency',currency:'BRL'})}`:'Cálculo real pelo Melhor Envio'):'entregas pausadas');if(c.retiradaAtiva)partes.push('retirada gratuita ativa');if(c.gratisAtivo&&c.entregaAtiva)partes.push(`grátis acima de ${Number(c.gratisAcima).toLocaleString('pt-BR',{style:'currency',currency:'BRL'})}`);partes.push(c.entregaAtiva?(ativas.length?`entrega em ${ativas.join(', ')}`:'nenhuma região atendida'):'checkout sem entrega');partes.push(`${c.diasPreparacao} dia(s) de preparação`);document.getElementById('freteResumoRegraMS').textContent=partes.join(' • ')+'.';}
...
async function salvarConfigFreteMS(){const st=document.getElementById('freteStatusMS');const c=lerConfigFreteFormMS();if(!c.entregaAtiva&&!c.retiradaAtiva)return alert('Ative entrega ou retirada no local.');if(c.entregaAtiva&&!Object.values(c.regioes).some(r=>r.ativo))return alert('Ative pelo menos uma região atendida.');if(c.entregaAtiva&&c.cepOrigem.length!==8)return alert('Informe um CEP de origem válido.');if(st){st.textContent='Salvando...';st.style.color='#e3b93f';}try{const r=await fetch(`${API_ADMIN_MS}/frete-config`,{method:'PUT',headers:{'Content-Type':'application/json'},body:JSON.stringify(c)});const d=await r.json();if(!r.ok)throw new Error(d.mensagem||'Erro ao salvar');preencherConfigFreteMS(d.config||c);if(st){st.textContent='Configurações publicadas ✓';st.style.color='#75df8e';}}catch(e){if(st){st.textContent=e.message;st.style.color='#ff7d8f';}}}
async function testarCepFreteMS(){const el=document.getElementById('freteTesteResultadoMS');const cep=String(document.getElementById('freteTesteCepMS')?.value||'').replace(/\D/g,'');if(cep.length!==8){if(el){el.textContent='Digite um CEP válido com 8 números.';el.className='frete-teste-resultado-ms erro';}return;}if(el){el.textContent='Testando conexão e região...';el.className='frete-teste-resultado-ms';}try{const r=await fetch(`${API_ADMIN_MS}/frete-teste`,{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({cep})});const d=await r.json();if(!r.ok)throw new Error(d.mensagem||'Não foi possível calcular.');if(el){el.textContent=`✓ CEP atendido (${d.uf}). Prazo configurado: ${d.prazoMin} a ${d.prazoMax} dias úteis. Melhor Envio ${d.melhorEnvioConfigurado?'conectado':'sem token'}.`;el.className='frete-teste-resultado-ms ok';}}catch(e){if(el){el.textContent=e.message;el.className='frete-teste-resultado-ms erro';}}}
...
const PAGAMENTO_PADRAO_ADMIN_MS={pixAtivo:true,cartaoAtivo:true,boletoAtivo:false,maxParcelas:12,valorMinimo:0};
let configPagamentoAdminMS={...PAGAMENTO_PADRAO_ADMIN_MS};
function preencherConfigPagamentoMS(c={}){configPagamentoAdminMS={...PAGAMENTO_PADRAO_ADMIN_MS,...c};const pix=document.getElementById('pagamentoPixAtivoMS'),cartao=document.getElementById('pagamentoCartaoAtivoMS'),parcelas=document.getElementById('pagamentoParcelasMS'),minimo=document.getElementById('pagamentoValorMinimoMS');if(pix)pix.checked=configPagamentoAdminMS.pixAtivo!==false;if(cartao)cartao.checked=configPagamentoAdminMS.cartaoAtivo!==false;if(parcelas)parcelas.value=String(Math.max(1,Math.min(12,Number(configPagamentoAdminMS.maxParcelas)||12)));if(minimo)minimo.value=Number(configPagamentoAdminMS.valorMinimo||0).toFixed(2);atualizarResumoPagamentoMS();}
function lerConfigPagamentoMS(){return {pixAtivo:!!document.getElementById('pagamentoPixAtivoMS')?.checked,cartaoAtivo:!!document.getElementById('pagamentoCartaoAtivoMS')?.checked,boletoAtivo:false,maxParcelas:Math.max(1,Math.min(12,Number(document.getElementById('pagamentoParcelasMS')?.value)||12)),valorMinimo:Math.max(0,Number(document.getElementById('pagamentoValorMinimoMS')?.value)||0)};}
function atualizarResumoPagamentoMS(){const el=document.getElementById('pagamentoResumoMS');if(!el)return;const c=lerConfigPagamentoMS();const formas=[];if(c.pixAtivo)formas.push('PIX');if(c.cartaoAtivo)formas.push(`cartão em até ${c.maxParcelas}x`);el.textContent=(formas.length?`Ativos: ${formas.join(' e ')}.`:'Nenhuma forma de pagamento ativa.')+(c.valorMinimo>0?` Compra mínima de ${c.valorMinimo.toLocaleString('pt-BR',{style:'currency',currency:'BRL'})}.`:' Sem valor mínimo de compra.');}
async function carregarResumoPagamentosMS(){try{const r=await fetch(`${API_ADMIN_MS}/pedidos?t=${Date.now()}`,{cache:'no-store'});const d=await r.json();const pedidos=Array.isArray(d)?d:(d.pedidos||[]);const status=p=>String(p.status||p.pagamento?.status||'').toLowerCase();const aprovados=pedidos.filter(p=>['pago','approved','aprovado'].some(x=>status(p).includes(x))).length;const recusados=pedidos.filter(p=>['recusado','rejected','cancelado','cancelled'].some(x=>status(p).includes(x))).length;const pendentes=Math.max(0,pedidos.length-aprovados-recusados);document.getElementById('pagamentosAprovadosMS').textContent=aprovados;document.getElementById('pagamentosPendentesMS').textContent=pendentes;document.getElementById('pagamentosRecusadosMS').textContent=recusados;}catch(e){} }
async function testarConexaoPagamentoMS(silencioso=false){const titulo=document.getElementById('pagamentoConexaoTituloMS'),texto=document.getElementById('pagamentoConexaoTextoMS'),bolinha=document.getElementById('pagamentoConexaoBolinhaMS');if(titulo)titulo.textContent='Verificando...';if(texto)texto.textContent='Consultando a API da loja.';if(bolinha)bolinha.className='pagamento-bolinha-ms';try{const r=await fetch(`${API_ADMIN_MS}/health?t=${Date.now()}`,{cache:'no-store'});const d=await r.json();if(!r.ok||!d.mercadoPagoConfigurado)throw new Error('Token não configurado no Render');if(titulo)titulo.textContent='Conectado';if(texto)texto.textContent='Mercado Pago pronto para receber pagamentos.';if(bolinha)bolinha.className='pagamento-bolinha-ms ok';if(!silencioso)alert('Mercado Pago conectado corretamente.');return true;}catch(e){if(titulo)titulo.textContent='Desconectado';if(texto)texto.textContent=e.message||'Não foi possível validar a conexão.';if(bolinha)bolinha.className='pagamento-bolinha-ms erro';if(!silencioso)alert('Mercado Pago não está conectado. Confira o ACCESS TOKEN no Render.');return false;}}
async function carregarPainelPagamentosMS(forcar=false){const st=document.getElementById('pagamentoStatusSalvarMS');if(st){st.textContent='Carregando...';st.style.color='#e3b93f';}try{const r=await fetch(`${API_ADMIN_MS}/pagamento-config?t=${Date.now()}`,{cache:'no-store'});const d=await r.json();if(!r.ok)throw new Error(d.mensagem||'Erro ao carregar');preencherConfigPagamentoMS(d);if(st)st.textContent='';}catch(e){preencherConfigPagamentoMS(PAGAMENTO_PADRAO_ADMIN_MS);if(st){st.textContent='Não consegui carregar as configurações.';st.style.color='#ff7d8f';}}await Promise.all([testarConexaoPagamentoMS(true),carregarResumoPagamentosMS()]);}
async function salvarConfigPagamentoMS(){const st=document.getElementById('pagamentoStatusSalvarMS');const c=lerConfigPagamentoMS();if(!c.pixAtivo&&!c.cartaoAtivo)return alert('Ative pelo menos uma forma de pagamento.');if(st){st.textContent='Salvando...';st.style.color='#e3b93f';}try{const r=await fetch(`${API_ADMIN_MS}/pagamento-config`,{method:'PUT',headers:{'Content-Type':'application/json'},body:JSON.stringify(c)});const d=await r.json();if(!r.ok)throw new Error(d.mensagem||'Erro ao salvar');preencherConfigPagamentoMS(d.config||c);if(st){st.textContent='Configurações publicadas ✓';st.style.color='#75df8e';}}catch(e){if(st){st.textContent=e.message;st.style.color='#ff7d8f';}}}
document.addEventListener('input',e=>{if(e.target?.closest?.('#pagamentosAba'))atualizarResumoPagamentoMS();});document.addEventListener('change',e=>{if(e.target?.closest?.('#pagamentosAba'))atualizarResumoPagamentoMS();});

// CENTRAL DE INTEGRAÇÕES ----------------------------------------------------
const INTEGRACOES_ESTADO_MS={};
function atualizarCardIntegracaoMS(chave,ok,titulo,detalhe){
  INTEGRACOES_ESTADO_MS[chave]=!!ok;
  const card=document.querySelector(`[data-integracao="${chave}"]`);if(!card)return;
  card.classList.toggle('conectada',!!ok);card.classList.toggle('erro',!ok);
  const st=card.querySelector('.integracao-status-texto-ms'),dt=card.querySelector('.integracao-detalhe-ms');
  if(st)st.textContent=titulo;if(dt)dt.textContent=detalhe;atualizarResumoIntegracoesMS();
}
function atualizarResumoIntegracoesMS(){const vals=Object.values(INTEGRACOES_ESTADO_MS);const ok=vals.filter(Boolean).length;const erro=vals.filter(v=>!v).length;const a=document.getElementById('integracoesConectadasMS'),b=document.getElementById('integracoesAtencaoMS'),c=document.getElementById('integracoesUltimaMS');if(a)a.textContent=ok;if(b)b.textContent=erro;if(c)c.textContent=new Date().toLocaleTimeString('pt-BR',{hour:'2-digit',minute:'2-digit'});}
async function carregarIntegracoesMS(forcar=false){
  document.querySelectorAll('.integracao-card-ms').forEach(c=>{c.classList.remove('conectada','erro');const s=c.querySelector('.integracao-status-texto-ms');if(s)s.textContent='Verificando...';});
  try{
    const [rh,rc]=await Promise.all([fetch(`${API_ADMIN_MS}/health?t=${Date.now()}`,{cache:'no-store'}),fetch(`${API_ADMIN_MS}/loja-config?t=${Date.now()}`,{cache:'no-store'})]);
    const health=await rh.json();const cfg=rc.ok?await rc.json():{};
    atualizarCardIntegracaoMS('mercadoPago',!!health.mercadoPagoConfigurado,health.mercadoPagoConfigurado?'Conectado':'Não configurado',health.mercadoPagoConfigurado?'Pronto para receber pagamentos.':'Confira o ACCESS TOKEN no Render.');
    atualizarCardIntegracaoMS('melhorEnvio',!!health.melhorEnvioConfigurado,health.melhorEnvioConfigurado?'Conectado':'Não configurado',health.melhorEnvioConfigurado?'Pronto para calcular entregas.':'Confira o token do Melhor Envio no Render.');
    atualizarCardIntegracaoMS('cloudinary',!!health.cloudinaryConfigurado,health.cloudinaryConfigurado?'Conectado':'Não configurado',health.cloudinaryConfigurado?'Pronto para enviar imagens.':'Confira as três chaves do Cloudinary no Render.');
    const whats=String(cfg.whatsapp||'').trim(),insta=String(cfg.instagram||'').trim();
    atualizarCardIntegracaoMS('whatsapp',!!whats,whats?'Cadastrado':'Não cadastrado',whats||'Adicione o número em Configurações.');
    atualizarCardIntegracaoMS('instagram',!!insta,insta?'Cadastrado':'Não cadastrado',insta||'Adicione o perfil em Configurações.');
    const dominio=location.origin.includes('localhost')?'https://ms-matias-style.onrender.com':location.origin;const el=document.getElementById('integracaoDominioMS');if(el)el.textContent=dominio;atualizarCardIntegracaoMS('dominio',true,'Ativo',dominio);
  }catch(e){['mercadoPago','melhorEnvio','cloudinary'].forEach(k=>atualizarCardIntegracaoMS(k,false,'Servidor indisponível','Não foi possível consultar agora.'));}
}
async function testarIntegracaoMS(chave){await carregarIntegracoesMS(true);const ok=INTEGRACOES_ESTADO_MS[chave];const nomes={mercadoPago:'Mercado Pago',melhorEnvio:'Melhor Envio',cloudinary:'Cloudinary'};alert(ok?`${nomes[chave]} está conectado corretamente.`:`${nomes[chave]} precisa ser configurado no Render.`);}


// ETAPA 5.3 - BACKUP E RECUPERAÇÃO -----------------------------------------
let backupsCacheMS = [];
function formatarBytesBackupMS(bytes){const n=Number(bytes||0);if(n<1024)return `${n} B`;if(n<1048576)return `${(n/1024).toFixed(1)} KB`;return `${(n/1048576).toFixed(2)} MB`;}
function dataBackupMS(valor){try{return new Date(valor).toLocaleString('pt-BR');}catch(_){return '-';}}
function apiBackupMS(){return (location.hostname==='localhost'||location.hostname==='127.0.0.1'||location.port==='5500'||location.protocol==='file:')?'http://localhost:3000':'https://ms-matias-style.onrender.com';}
function escaparBackupMS(v){return String(v||'').replace(/[&<>"']/g,m=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#039;'}[m]));}
function statusBackupMS(texto,tipo=''){const el=document.getElementById('backupsStatusMS');if(!el)return;el.textContent=texto||'';el.className=`backups-status-ms ${tipo}`;}
async function carregarBackupsMS(mostrar=false){
  const lista=document.getElementById('backupsListaMS');if(!lista)return;if(mostrar)statusBackupMS('Atualizando lista...');
  try{const r=await fetch(`${apiBackupMS()}/backups?t=${Date.now()}`,{cache:'no-store'});const d=await r.json().catch(()=>[]);if(!r.ok)throw new Error(d.mensagem||'Não foi possível carregar os backups.');backupsCacheMS=Array.isArray(d)?d:[];renderizarBackupsMS();if(mostrar)statusBackupMS('Lista atualizada.','sucesso');}
  catch(e){lista.innerHTML=`<div class="backups-vazio-ms erro">${escaparBackupMS(e.message)}</div>`;statusBackupMS(e.message,'erro');}
}
function renderizarBackupsMS(){
  const lista=document.getElementById('backupsListaMS');if(!lista)return;
  document.getElementById('backupTotalMS').textContent=backupsCacheMS.length;
  document.getElementById('backupUltimoMS').textContent=backupsCacheMS[0]?dataBackupMS(backupsCacheMS[0].criado_em):'Nenhum';
  document.getElementById('backupTamanhoMS').textContent=formatarBytesBackupMS(backupsCacheMS.reduce((s,b)=>s+Number(b.tamanho_bytes||0),0));
  if(!backupsCacheMS.length){lista.innerHTML='<div class="backups-vazio-ms"><b>Nenhum backup criado</b><span>Crie o primeiro antes da próxima alteração importante.</span></div>';return;}
  lista.innerHTML=backupsCacheMS.map(b=>{const c=b.contagens||{};const itens=Object.values(c).reduce((s,n)=>s+Number(n||0),0);return `<article class="backup-card-ms"><div class="backup-icone-ms">💾</div><div class="backup-info-ms"><h4>${escaparBackupMS(b.nome)}</h4><p>${dataBackupMS(b.criado_em)} · ${formatarBytesBackupMS(b.tamanho_bytes)} · ${itens} registros</p><small>SHA-256: ${escaparBackupMS(String(b.hash_sha256||'').slice(0,16))}… ${b.restaurado_em?` · restaurado em ${dataBackupMS(b.restaurado_em)}`:''}</small></div><div class="backup-acoes-ms"><button onclick="baixarBackupMS(${b.id})">⬇ Baixar</button><button class="restaurar" onclick="restaurarBackupMS(${b.id})">↶ Restaurar</button><button class="excluir" onclick="excluirBackupMS(${b.id})">Excluir</button></div></article>`;}).join('');
}
async function criarBackupMS(){const nome=prompt('Nome opcional para este backup:',`Antes da alteração - ${new Date().toLocaleDateString('pt-BR')}`);if(nome===null)return;statusBackupMS('Criando backup completo...');try{const r=await fetch(`${apiBackupMS()}/backups`,{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({nome:nome.trim()})});const d=await r.json().catch(()=>({}));if(!r.ok)throw new Error(d.mensagem||'Falha ao criar backup.');statusBackupMS('Backup criado com sucesso.','sucesso');await carregarBackupsMS();}catch(e){statusBackupMS(e.message,'erro');alert(e.message);}}
