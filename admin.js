...
const FRETE_PADRAO_ADMIN_MS={gratisAtivo:false,gratisAcima:199.90,fixoAtivo:false,fixoValor:15,medidasCategorias:{},regioes:{sul:{ativo:true,min:3,max:7},sudeste:{ativo:true,min:4,max:8},centroOeste:{ativo:true,min:5,max:10},nordeste:{ativo:true,min:7,max:14},norte:{ativo:true,min:9,max:18}}};
